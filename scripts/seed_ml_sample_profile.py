...
bertanggal mundur satu hari per baris, supaya window baseline 30 hari
memuat semuanya sekaligus melewati cold-start 14 hari.
...
def main(email: str) -> None:
    with SessionLocal() as db:
        ...
        for offset, (heart_rate, respiration_rate) in enumerate(SOURCE_ROWS):
