...
[![Tests](https://img.shields.io/badge/tests-75_passed-2EA043?style=for-the-badge&logo=pytest&logoColor=white)](#testing)
...
- **Tanya pakai bahasa sehari-hari.** Chatbot menjawab pertanyaan tentang data ("gimana detak
  jantung saya minggu ini?"), mengingat riwayat kesehatan yang diceritakan, dan mencatat
  aktivitas dari kalimat biasa seperti "baru ngopi 2 cangkir".
...
| **Chatbot** | LangChain + DeepSeek, tool-calling ke data asli, memory riwayat kesehatan lewat RAG |
...
| [FastAPI](https://fastapi.tiangolo.com/) | 0.115 | Web framework, OpenAPI docs otomatis |
...
| [Pydantic](https://docs.pydantic.dev/) | 2.10 | Validasi & serialisasi |
...
| Teknologi | Versi | Peran |
|---|---|---|
| [PyJWT](https://pyjwt.readthedocs.io/) | 2.10 | Token akses |
| [bcrypt](https://github.com/pyca/bcrypt/) | 4.2 | Hashing password |
| [LangChain](https://www.langchain.com/) | — | Orkestrasi agent & tool-calling *(Fase 2)* |
| [DeepSeek](https://www.deepseek.com/) | — | LLM chatbot *(Fase 2)* |
| [Chainlit](https://chainlit.io/) | — | UI chat, di-embed sebagai iframe *(Fase 2)* |
...
| `JWT_SECRET` | **Ya** | — | Kunci penandatangan token. Kosong = error |
| `JWT_EXPIRE_MINUTES` | — | `1440` | Masa berlaku token (menit) |
| `VIDEO_STORAGE_PATH` | — | `./data/videos` | Lokasi video mentah di filesystem |
| `DEEPSEEK_API_KEY` | Fase 2 | — | API key LLM chatbot |
| `TELEGRAM_BOT_TOKEN` | Fase 2 | — | Token bot notifikasi |
...
| Fase | Lingkup | Status |
|---|---|:---:|
| **1** | Auth & family, capture + rPPG, statistik, activity log, notifikasi Telegram | 🚧 Berjalan |
| **2** | Chatbot DeepSeek + LangChain, memory RAG, activity via chat | ⏳ |
